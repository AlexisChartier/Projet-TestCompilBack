...
class PongLogicTest {
    ...
    void testUpdate_BallHitsWall_Left() {
        ...
        // Check if turn is reset and ball's position is reset
        assertNotNull(PongGameData.getInstance().getTurn());
    ...
    void testUpdate_BallHitsWall_Right() {
        ...
        // Check if turn is reset and ball's position is reset
        assertNotNull(PongGameData.getInstance().getTurn());
        assertTrue(PongGameData.getInstance().getBall().getX() < 1400);
    }
